...
namespace Reluca.Tools.Creators
{
    /// <summary>
    ...
    public class FeaturePatternCreator
    {
        ...
        {
            var input = FileHelper.ReadTextLines("../../../Resources/feature-pattern-input.txt");
            var output = Create(input);
            FileHelper.WriteJson(output, "../../../Output/feature-pattern.json", Formatting.Indented);
        }
